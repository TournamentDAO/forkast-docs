...
- **Example**: A trader places a market order to buy 60 shares of **Ronin Yes**. The system matches the order with the first corresponding ask — 60 shares at $0.60.
...
- **Example**: A trader places a limit order to buy 75 shares of **Ronin Yes** at $0.50. The order remains on the order book until a seller matches the price.
...
## 🗂️ Managing and Canceling Orders
