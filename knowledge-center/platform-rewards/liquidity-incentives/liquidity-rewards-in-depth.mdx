...
- Your orders must be inside the range of the max spread and the MidPoint to qualify: Bottom \[MidPoint − max spread] and Top \[MidPoint + max spread]
...
- When the midpoint is within $0.10 – $0.90, you can earn rewards from just one side (bid or ask).
  - Example $0.11 or $0.89
- When the midpoint is below $0.10 or above $0.90, you must provide liquidity on both sides (buy and sell) to qualify. 
  - Example $0.09 or $0.91
